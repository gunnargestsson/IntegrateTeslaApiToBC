...
codeunit 90202 LibraryAssert
{
    ...
    internal procedure AreEqual(ExpectedVariant: Variant; ActualVariant: Variant; Msg: Text)
    begin
    ...
    internal procedure AreEqual(Expected: Dictionary of [Text, Text]; Actual: Dictionary of [Text, Text])
    var
        ActualValue: Text;
        ExpectedValue: Text;
        "Key": Text;
    ...
    /// <param name="Msg">The message to include in the exception when actual is not equal to expected. The message is shown in test results.</param>
    internal procedure AreEqualDateTime(Expected: DateTime; Actual: DateTime; Msg: Text)
    begin
    ...
    internal procedure AreNearlyEqual(Expected: Decimal; Actual: Decimal; Delta: Decimal; Msg: Text)
    begin
    ...
    /// <param name="ActualVariant">The second value to compare. This is the value produced by the code under test.</param>
    /// <param name="Msg">The message to include in the exception when actual is not equal to expected. The message is shown in test results.</param>
    internal procedure AreNotEqual(ExpectedVariant: Variant; ActualVariant: Variant; Msg: Text)
    begin
    ...
    internal procedure AreNotNearlyEqual(Expected: Decimal; Actual: Decimal; Delta: Decimal; Msg: Text)
    begin
        if Abs(Expected - Actual) <= Abs(Delta) then
    ...
    /// </summary>
    internal procedure AssertNoFilter()
    begin
    ...
    /// </summary>
    internal procedure AssertNothingInsideFilter()
    begin
    ...
    /// </summary>
    internal procedure AssertPrimRecordNotFound()
    begin
    ...
    /// </summary>
    internal procedure AssertRecordAlreadyExists()
    begin
    ...
    /// </summary>
    internal procedure AssertRecordNotFound()
    begin
    ...
    internal procedure ExpectedError(Expected: Text)
    begin
    ...
    internal procedure ExpectedErrorCode(Expected: Text)
    begin
    ...
    /// <param name="Expected">The first value to compare. This is the value the tests expects not to match actual.</param>
    /// <param name="Actual">The second value to compare. This is the value produced by the code under test.</param>
    internal procedure ExpectedMessage(Expected: Text; Actual: Text)
    begin
    ...
    internal procedure Fail(Msg: Text)
    begin
    ...
    internal procedure IsFalse(Condition: Boolean; Msg: Text)
    begin
        if Condition then
    ...
    internal procedure IsTrue(Condition: Boolean; Msg: Text)
    begin
    ...
    internal procedure KnownFailure(Expected: Text; WorkItemNo: Integer)
    begin
    ...
    internal procedure RecordCount(RecVariant: Variant; ExpectedCount: Integer)
    var
        RecordRef: RecordRef;
    begin
    ...
    internal procedure RecordIsEmpty(RecVariant: Variant)
    var
        RecordRef: RecordRef;
    begin
        RecordRef.GetTable(RecVariant);
    ...
    /// </summary>
    /// <param name="RecVariant">The record to be checked</param>
    internal procedure RecordIsNotEmpty(RecVariant: Variant)
    var
        RecordRef: RecordRef;
    begin
        RecordRef.GetTable(RecVariant);
    ...
    internal procedure TableIsEmpty(TableNo: Integer)
    var
        RecordRef: RecordRef;
    begin
    ...
    internal procedure TableIsNotEmpty(TableNo: Integer)
    var
        RecordRef: RecordRef;
    begin
        RecordRef.Open(TableNo);
    ...
    local procedure VerifyFailure(expectedErrorCode2: Text; failureText: Text)
    var
        errorCode: Text;
    begin
        errorCode := GetLastErrorCode();

        IsTrue(errorCode = expectedErrorCode2, failureText);
        ClearLastError();
    end;
}
